...
| Track | Eligibility |
|---|---|
| Student Authority (Minhal HaStudentim) | Oleh Chadash for BA. The post-army eligibility window for olim was extended (5 years for regular service, 7 years for career service since the post-Oct-2023 amendments). תשפ"ו application deadline: 31.7.2026; payment-slip + enrollment confirmation by 30.8.2026. |
...
- Mimadim LiLimudim is graduated (85% Years 1-2, top-up Year 3). Don't budget Year 1 at full tuition or the user is short ~15% out of pocket.
